...
- **Инфраструктура простая.** Пара серверов — Ansible здесь избыточен.
- **Сервер новый.** Инфраструктура ещё свежая, Ansible на ней пока не настроен, а сделать что-то нужно уже сейчас.
- **Просто хочется хранить скрипты.** Все полезные скрипты в одном месте, под рукой.


## Как это работает

1. Пишем скрипт прямо в браузере. `#!/bin/bash` добавлять не нужно — он подставляется автоматически.
...
> Всё равно, лучше не хранить здесь чувствительные данные!
